...
ggplot(ice_extent_yearly) +
    ...
    labs(
        ...
        colour = "Extent Type",
        title = "Yearly Min and Max Sea Ice Extent",
        subtitle = "Arctic and Antarctic Sea Ice Trends"
    ) +
    theme_minimal()
...
ggplot(cyclones_ice_data) +
    ...
    labs(
        ...
        subtitle = "Faceted by Arctic and Antarctic Regions"
    ) +
    theme_minimal()
...
```{r}
cyclones_data %>%
    group_by(year = ObservYear, region, category) |>
    ...
    labs(
        x = "Year",
        y = "Cyclone Count",
        fill = "Cyclone Category",
        title = "Cyclone Counts by Category Over Time",
        subtitle = "Arctic vs. Antarctic Cyclone Trends by Intensity"
    ) +
    theme_minimal()
