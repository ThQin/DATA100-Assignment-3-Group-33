...
ggplot(cyclones_ice_yearly) +
    aes(x = avg_ice_extent, y = max_wind, color = category) +
    ...
    labs(
        ...
        subtitle = "Comparing Intensity and Sea Ice Levels Across Cyclone Categories"
    ) +
    theme_minimal()

```

PLOT2 :![](images/clipboard-1163357977.png)
